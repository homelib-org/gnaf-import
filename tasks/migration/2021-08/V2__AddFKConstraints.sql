...
ALTER TABLE ADDRESS_CHANGE_TYPE_AUT
...
ALTER TABLE ADDRESS_MESH_BLOCK_2021
...
ALTER TABLE ADDRESS_FEATURE
ADD CONSTRAINT ADDRESS_FEATURE_FK1 FOREIGN KEY (address_change_type_code) REFERENCES ADDRESS_CHANGE_TYPE_AUT (code);

ALTER TABLE ADDRESS_FEATURE
ADD CONSTRAINT ADDRESS_FEATURE_FK2 FOREIGN KEY (address_detail_pid) REFERENCES ADDRESS_DETAIL (address_detail_pid);
